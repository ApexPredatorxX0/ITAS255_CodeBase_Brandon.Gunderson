...
class Testimonial_Slider extends Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'down' => [
						'title' =>__( 'Down', 'definitive-addons-for-elementor' ),
       ...
       $this->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .widget-testimonial-slide .slick-prev:after, {{WRAPPER}} .widget-testimonial-slide .slick-next:after' => 'color: {{VALUE}};',
                ],
            ]
        );
		...
		$this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .widget-testimonial-slide .slick-prev:hover:after, {{WRAPPER}} .widget-testimonial-slide .slick-next:hover:after' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
				...
				'default' =>'#6EC1E4',
                'selectors' => [
                    '{{WRAPPER}} .widget-testimonial-slide .slick-prev, {{WRAPPER}} .widget-testimonial-slide .slick-next' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .widget-testimonial-slide .slick-prev:hover, {{WRAPPER}} .widget-testimonial-slide .slick-next:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
	...
	protected function render( ) {
		...
		if($align == "down"){
		  ...
		  $reviewer_styles = 'margin-left: auto;margin-right: auto;';
		}
			...
			<?php foreach ( $settings['slick_slides'] as $slide ) {
				...
				<div class="left-style"> 
					<div class="avatar"  style="<?php echo esc_attr($avatar_styles) ?>">
					 ...
					 <img class="reviewer-photo" style="<?php echo esc_attr($reviewer_styles) ?>" alt="Author Photo"
					src="<?php echo esc_url($slider_image) ?>" />
